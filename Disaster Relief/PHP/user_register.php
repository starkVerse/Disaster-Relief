...
<head>
    ...
    <title>Sign In</title>
    <link rel="stylesheet" href="/WT_Project/CSS/user_register.css">
</head>
<body>
    <div class="header">
        <div class="logo">Disaster Relief</div>
        <div class="signin-register"><a href="user_signin.php">Sign In/Register</a></div>
    </div>
    <nav>
        <div class="container">
            <ul>
    ...
    <form action="/WT_Project/PHP/user_message.php" method="post">
