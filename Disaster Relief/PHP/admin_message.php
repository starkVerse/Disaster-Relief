...
<head>
    ...
    <link rel="stylesheet" href="/WT_Project/CSS/admin_mssg_style.css">
    <title>Message</title>
...
<?php
    ...
    $query = "insert into admin_data (admin_id,user_name,email_add,phone_number,passwords) values ('','$fname','$email','$p_num','$passwrd')";
